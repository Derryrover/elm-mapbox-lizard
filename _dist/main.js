...
var author$project$Main$geojson = A2(
...
var gampleman$elm_mapbox$Mapbox$Expression$any = gampleman$elm_mapbox$Mapbox$Expression$calln('any');
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								gampleman$elm_mapbox$Mapbox$Element$maxZoom(5),
						...
						gampleman$elm_mapbox$Mapbox$Style$Style(
							{
									...
									[
										...
										_List_fromArray(
											[
												...
												gampleman$elm_mapbox$Mapbox$Expression$any(
													_List_fromArray(
														[
															A2(
												...
												A4(gampleman$elm_mapbox$Mapbox$Expression$rgba, 227, 227, 227, 1)),
								...
								misc: _List_fromArray(
									[
										...
										gampleman$elm_mapbox$Mapbox$Style$sprite('mapbox://sprites/mapbox/light'),
										gampleman$elm_mapbox$Mapbox$Style$glyphs('mapbox://fonts/mapbox/{fontstack}/{range}.pbf')
									]),
								sources: _List_fromArray(
									[
										A2(gampleman$elm_mapbox$Mapbox$Source$vectorFromUrl, 'composite', 'mapbox://mapbox.mapbox-terrain-v2,mapbox.mapbox-streets-v7,astrosat.07pz1g3y'),
										A3(gampleman$elm_mapbox$Mapbox$Source$geoJSONFromValue, 'changes', _List_Nil, author$project$Main$geojson)
									]),
